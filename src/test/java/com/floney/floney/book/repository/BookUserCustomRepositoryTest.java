...
public class BookUserCustomRepositoryTest {
    ...
    void getBookUser() {
        User savedUser = userRepository.save(UserFixture.emailUser());
    ...
    void allUser() {
        ...
        User user1 = userRepository.save(UserFixture.emailUser());
        BookUser bookUser1 = BookFixture.createBookUser(user1, savedBook);

        User user2 = userRepository.save(UserFixture.kakaoUser());
